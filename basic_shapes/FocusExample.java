...
// show what we've done
        SwingUtilities.invokeLater( // ask the doctor about this
                new Runnable() {
                    public void run() {
                        app.setVisible(true);
                    }
...
//only three JOGL lines of code ... and here they are
        ...
        FocusExampleDisplay fed1 = new FocusExampleDisplay("Red", glcanvasWest);

        glcanvasWest.addGLEventListener(fed1);
        glcanvasWest.addFocusListener(fed1);

        GLCanvas glcanvasEast = new GLCanvas();
        FocusExampleDisplay fed2 = new FocusExampleDisplay("Blue", glcanvasEast);
